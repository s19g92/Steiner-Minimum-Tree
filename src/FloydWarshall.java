...
class FloydWarshall {
	// Set Infinity value and the number of vertices.
	final static int INF = 99999, V = 4;

	void shortestDistance(int graph[][]) {
		int dist[][] = new int[V][V];
		int nexthop[][] = new int[V][V];
		int i, j, k;
		...
		printSolution(dist, nexthop);
	}

	void printSolution(int dist[][], int nexthop[][]) {
	...
	public static void main(String[] args) {
		...
		/*
		 * Let us create the following weighted graph 10 (0)------->(3) | /|\ |
		 * 5 | | | 1 \|/ | (1)------->(2) 3
		 */
